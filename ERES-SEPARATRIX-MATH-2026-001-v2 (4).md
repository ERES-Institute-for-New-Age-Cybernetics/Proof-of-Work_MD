...
- A LinkedIn correspondent (April 22–24, 2026) contributed, scope-limited to: (i) identification of the pre-threshold failure mode (Section 1.3), and (ii) articulation of the separatrix-crossing boundary condition (Section 2.1 motivation). The correspondent elected the LinkedIn-correspondence tier under ERES Attribution Protocol rather than named attribution. Does not constitute endorsement of the specific mathematical form (three proxies, binary composite, calibration values, worked example).
...
- **v2 (2026-04-24, afternoon) — THIS VERSION** — Binary DSAP-PRE composite locked as normative (Mode A for θ ≥ 0.75). Three Governing Principles correspondence added (Section 7, ERES-originated). Reference calibration values pinned. DOFA worked example traced through. ECR methodology referenced. LinkedIn-correspondence-tier citation for peer review; no named attribution.

---

## Preamble

This math sheet specifies the mathematical scaffolding for **DSAP-PRE** — the Pre-threshold Decision Space Accessibility layer above the four-factor Proof-of-Resonance in EAAP v1.3-FINAL. It addresses the failure mode identified through LinkedIn correspondence during April 22–23, 2026: the moment at which a system enters a regime of irreversible path dependency, while all current state, cycle, path, and future-map metrics still evaluate above authorization threshold.
...
Per the correspondent (April 23, 2026, 8:26 AM):
...
### 10.4 LinkedIn Correspondent Position Statement — Scope-Limited Contribution
...
> My contribution is limited to identifying the structural failure mode and articulating the boundary condition. The implementation — including the specific mathematical form, proxies, and calibration — is entirely yours. [...] Once the concepts are more independently established in my own work as well, I'd be open to revisiting named attribution under your protocol.

**Scope of contribution credited in this math sheet, limited to these two respects:**
...
**Correspondent's structural positioning condition (April 24, 2026):**
...
**Contribution does NOT extend to:** endorsement of the specific mathematical form (three proxies, binary composite, calibration values, worked example). Sections 3, 4, 5, 6, 7, 8, 9, 10, 11, and 12 of this math sheet are the sole responsibility of Joseph Allen Sprute and the ERES Institute.

**Future tier elevation available.** The correspondent has reserved the option of revisiting named attribution once the underlying concepts are more independently established in the correspondent's own publicly available work. Correspondence record retained by the ERES Institute as internal provenance record per Attribution Protocol §6.
...
### 12.2 Peer Review Correspondence

- LinkedIn correspondence with J.A. Sprute, four-turn review plus final review, April 22–24, 2026. Correspondent elected LinkedIn-correspondence tier under ERES Attribution Protocol. Source for Section 1.3 and Section 2.1 motivation. Correspondence record retained under Protocol provenance.
