...
**V3.** Named, stable attribution to Villa for runtime containment framing (Section 7) and sovereignty-domain mapping (Section 8). Revisions that remove or generalize this attribution without Villa's written consent are non-conformant.
...
**Villa's stated approval position (April 24, 2026), reproduced with permission:**
...
**Invariant V3 — Attribution Integrity.** Attribution to Villa in runtime containment framing (VBE) and sovereignty-domain mapping within DSAP-PRE MUST remain named and stable in v1.3-FINAL and companion documents. Subsequent revisions that remove or generalize this attribution without Villa's written consent are non-conformant.

Villa's approval is conditional on V1–V3 being preserved. Publication under CCAL v2.1 is on that basis.
