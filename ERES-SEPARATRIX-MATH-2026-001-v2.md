...
- Teresa Villa (Named Contributor), Founder, JusticeTree AI — Sovereignty Layer Mapping (Section 7)

**Named Peer Reviewer:**
- Andrzej Skulski, AI Governance / Decision–Commit Boundary, Founder, Dom Ciszy – Resonance Lab — Pre-threshold regime-transition formulation (Section 2)
...
### 10.4 Attribution per Attribution Protocol

- **Andrzej Skulski** (LinkedIn correspondence, April 22–23, 2026) — identified the pre-threshold regime-transition failure mode (Section 1.3 quote). Source of DSAP-PRE's existence as a construct. Named Peer Reviewer per ERES-ATTRIBUTION-PROTOCOL-2026-001-v1.
- **Teresa Villa** (contributed PDF, April 23, 2026) — contributed the three-domain sovereignty mapping (Section 7 verbatim). Named Contributor per ERES-ATTRIBUTION-PROTOCOL-2026-001-v1.
